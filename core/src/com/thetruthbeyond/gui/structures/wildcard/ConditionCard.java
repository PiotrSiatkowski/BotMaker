...
public class ConditionCard extends Wildcard {
	
	private int index;
	
	public ConditionCard(String name, Color color) {
		super(name, color);
	}

	@Override
	public void fillTemplate(List<AIMLElement> elements, AIMLGenerator generator) {
		List<AIMLElement> conditions = generator.getAimlElements(null, this);
		elements.addAll(conditions);
	}

	public ConditionCard setIndex(int index) {
		this.index = index;
		return this;
	}
	...
	public boolean equals(Object obj) {
		if(super.equals(obj)) {
			if(obj instanceof ConditionCard) {
				ConditionCard compared = (ConditionCard) obj;
