...
public class CheckBoxListConfiguration extends ControllerConfiguration {
	public int boxes;
	public int padding = 0;
	
	public float relativeGap = 0.1f;
	
	public boolean alignVertical 			= false;
	public boolean setIdealSize				= false;
	public boolean fitHeightByMinimizing	= true;
}
