...
public class ScrollPanelConfiguration extends ControllerConfiguration {
	public int columnsNumber;
	public int rowsNumber;
	
	public float relativePadding;
	public float relativeGapW;
	public float relativeGapH;
	public float backgroundAlpha = 1.0f;
	
	public ScrollBar scrollbar;
	
	public boolean letResizeArea = false;
	public boolean includeBoundaryPadding = true;
	public boolean drawBackground = true;
	public boolean drawScrollBarEvenIfCantBeScrolled = false;
}
