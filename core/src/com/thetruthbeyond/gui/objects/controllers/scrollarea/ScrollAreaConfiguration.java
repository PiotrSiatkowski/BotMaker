...
public class ScrollAreaConfiguration extends BackgroundAreaConfiguration {
	public ScrollBar scrollbar = null;
	
	public int maxMessagesShown;	

	public float relativeAreaPadding;
	public float relativeTextPadding;
	public float textBackgroundAlpha;
