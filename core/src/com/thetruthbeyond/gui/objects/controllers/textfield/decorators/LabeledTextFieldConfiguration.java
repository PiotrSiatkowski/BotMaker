...
public class LabeledTextFieldConfiguration extends ControllerConfiguration {

	public FontType 	labelFontname;

	public String		labelTitle;
	
	public Color		labelFontColor;

	public float 		relativeLabelPaddingX;
	public float 		relativeLabelPaddingY;
	public float		labelSizeParameter = 1.0f;
