...
public abstract class OperationSubTab extends Tab implements AIMLGenerator {

	protected OperationSubTab(Area area, Clickable parent) {
		super(area, parent);
	}

	public abstract void confirmTabData();
	public abstract void cancel_TabData();
}
