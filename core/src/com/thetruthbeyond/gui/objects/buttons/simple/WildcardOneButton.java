...
public class WildcardOneButton extends Button {

	public WildcardOneButton(FileManager loader, Clickable parent) {
		super(parent);
		initialize(loader);
	}
	
	public WildcardOneButton(Area area, FileManager loader, Clickable parent) {
		super(area, parent);
		initialize(loader);
	}
	...
	protected void initialize(FileManager loader) {
		button = loader.getTexture("WildcardRed");
		buttonHover = loader.getTexture("WildcardRedHover");
		shape = Shape.Oval;
