...
public class ConditionTwoButton extends Button {

	public ConditionTwoButton(FileManager loader, Clickable parent) {
		super(parent);
		initialize(loader);
	}
	
	public ConditionTwoButton(Area area, FileManager loader, Clickable parent) {
		super(area, parent);
		initialize(loader);
	}
	...
	protected void initialize(FileManager loader) {
		button = loader.getTexture("ConditionBlue");
		buttonHover = loader.getTexture("ConditionBlueHover");
		shape = Shape.Oval;
