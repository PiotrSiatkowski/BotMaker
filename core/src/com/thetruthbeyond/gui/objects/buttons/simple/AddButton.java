...
public class AddButton extends Button {
	...
	public AddButton(FileManager loader, Clickable parent) {
		super(parent);
		initialize(loader);
	}
	
	public AddButton(Area area, FileManager loader, Clickable parent) {
		super(area, parent);
		initialize(loader);
	}
	...
	protected void initialize(FileManager loader) {
		button = loader.getTexture("ConditionAdd");
		buttonHover = loader.getTexture("ConditionAddHover");
		shape = Shape.Oval;
