...
public class WindowsPublishButton extends Button {

	public WindowsPublishButton(FileManager loader, Clickable parent) {
		super(parent);
		initialize(loader);
	}
	
	public WindowsPublishButton(Area area, FileManager loader, Clickable parent) {
		super(area, parent);
		initialize(loader);
	}
	...
	protected void initialize(FileManager loader) {
		button = loader.getTexture("Publish");
		buttonHover = loader.getTexture("PublishOn");
		shape = Shape.Oval;
