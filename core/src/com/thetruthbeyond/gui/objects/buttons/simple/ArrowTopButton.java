 ...
 */
public class ArrowTopButton extends Button {
    public ArrowTopButton(FileManager loader, Clickable parent) {
        super(parent);
        initialize(loader);
    }

    public ArrowTopButton(Area area, FileManager loader, Clickable parent) {
        super(area, parent);
        initialize(loader);
    }
    ...
    protected void initialize(FileManager loader) {
        button = loader.getTexture("ScrollBarArrowUp");
        buttonHover = loader.getTexture("ScrollBarArrowUpHover");
