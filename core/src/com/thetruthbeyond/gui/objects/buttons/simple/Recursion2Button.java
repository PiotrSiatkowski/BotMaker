...
public class Recursion2Button extends Button {

	public Recursion2Button(FileManager loader, Clickable parent) {
		super(parent);
		initialize(loader);
	}
	
	public Recursion2Button(Area area, FileManager loader, Clickable parent) {
		super(area, parent);
		initialize(loader);
	}
	...
	protected void initialize(FileManager loader) {
		button = loader.getTexture("RecursionBlue");
		buttonHover = loader.getTexture("RecursionBlueHover");
		shape = Shape.Oval;
