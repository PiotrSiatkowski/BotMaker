...
public class Recursion3Button extends Button {

	public Recursion3Button(FileManager loader, Clickable parent) {
		super(parent);
		
		button = loader.getTexture("RecursionGreen");
		buttonHover = loader.getTexture("RecursionGreenHover");
		shape = Shape.Oval;
	...
	public Recursion3Button(Area area, FileManager loader, Clickable parent) {
		super(area, parent);
		initialize(loader);
	}
