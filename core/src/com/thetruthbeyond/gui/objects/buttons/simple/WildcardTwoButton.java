...
public class WildcardTwoButton extends Button {

	public WildcardTwoButton(FileManager loader, Clickable parent) {
		super(parent);
		initialize(loader);
	}
	
	public WildcardTwoButton(Area area, FileManager loader, Clickable parent) {
		super(area, parent);
		initialize(loader);
	}
	...
	protected void initialize(FileManager loader) {
		button = loader.getTexture("WildcardBlue");
		buttonHover = loader.getTexture("WildcardBlueHover");
		shape = Shape.Oval;
