...
public class RandomOneButton extends Button {

	public RandomOneButton(FileManager loader, Clickable parent) {
		super(parent);
		initialize(loader);
	}
	
	public RandomOneButton(Area area, FileManager loader, Clickable parent) {
		super(area, parent);
		initialize(loader);
	}
	...
	protected void initialize(FileManager loader) {
		button = loader.getTexture("RandomViolet");
		buttonHover = loader.getTexture("RandomVioletHover");
		shape = Shape.Oval;
