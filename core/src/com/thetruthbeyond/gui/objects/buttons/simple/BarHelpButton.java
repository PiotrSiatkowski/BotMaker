...
public class BarHelpButton extends Button {

	public BarHelpButton(FileManager loader, Clickable parent) {
		super(parent);
		initialize(loader);
	}
	
	public BarHelpButton(Area area, FileManager loader, Clickable parent) {
		super(area, parent);
		initialize(loader);
	}
	...
	protected void initialize(FileManager loader) {
		button = loader.getTexture("Help");
		buttonHover = loader.getTexture("HelpOn");
