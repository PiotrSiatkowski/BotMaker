...
public class Recursion1Button extends Button {

	public Recursion1Button(FileManager loader, Clickable parent) {
		super(parent);
		initialize(loader);
	}


	public Recursion1Button(Area area, FileManager loader, Clickable parent) {
		super(area, parent);
		initialize(loader);
	}
	...
	protected void initialize(FileManager loader) {
		button = loader.getTexture("RecursionRed");
		buttonHover = loader.getTexture("RecursionRedHover");
		shape = Shape.Oval;
