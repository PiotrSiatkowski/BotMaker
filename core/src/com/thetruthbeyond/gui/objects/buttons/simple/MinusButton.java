...
public class MinusButton extends Button {
	...
	public MinusButton(FileManager loader, Clickable parent) {
		super(parent);
		initialize(loader);
	}
	
	public MinusButton(Area area, FileManager loader, Clickable parent) {
		super(area, parent);
		initialize(loader);
	}
	...
	protected void initialize(FileManager loader) {
		button = loader.getTexture("ButtonMinus");
		buttonHover = loader.getTexture("ButtonMinusHover");
		shape = Shape.Oval;
