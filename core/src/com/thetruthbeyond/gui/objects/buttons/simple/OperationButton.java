...
public class OperationButton extends Button {
	...
	public OperationButton(FileManager loader, Clickable parent) {
		super(parent);
		initialize(loader);
	}
	
	public OperationButton(Area area, FileManager loader, Clickable parent) {
		super(area, parent);
		initialize(loader);
	}
	...
	protected void initialize(FileManager loader) {
		button = loader.getTexture("OperationButton");
		buttonHover = loader.getTexture("OperationButtonHover");
