...
public class CancelButton extends Button {
	...
	public CancelButton(FileManager loader, Clickable parent) {
		super(parent);
		initialize(loader);
	}
	
	public CancelButton(Area area, FileManager loader, Clickable parent) {
		super(area, parent);
		initialize(loader);
	}
	...
	protected void initialize(FileManager loader) {
		button = loader.getTexture("Cancel");
		buttonHover = loader.getTexture("CancelHover");
		shape = Shape.Oval;
