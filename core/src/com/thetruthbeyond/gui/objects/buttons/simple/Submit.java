...
public class Submit extends Button {
	public Submit(FileManager loader, Clickable parent) {
		super(parent);
		initialize(loader);
	}


	public Submit(Area area, FileManager loader, Clickable parent) {
		super(area, parent);
		initialize(loader);
	}
	...
	protected void initialize(FileManager loader) {
		button = loader.getTexture("Submit");
		buttonHover = loader.getTexture("SubmitHover");
		shape = Shape.Oval;
