...
public class BarMinimizeButton extends Button {

	public BarMinimizeButton(FileManager loader, Clickable parent) {
		super(parent);
		initialize(loader);
	}
	
	public BarMinimizeButton(Area area, FileManager loader, Clickable parent) {
		super(area, parent);
		initialize(loader);
	}

	@Override
	public void initialize(FileManager loader) {
		button = loader.getTexture("Minimalize");
		buttonHover = loader.getTexture("MinimalizeOn");
