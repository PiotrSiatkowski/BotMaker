...
public class BarExitButton extends Button {

	public BarExitButton(FileManager loader, Clickable parent) {
		super(parent);
		initialize(loader);
	}
	
	public BarExitButton(Area area, FileManager loader, Clickable parent) {
		super(area, parent);
		initialize(loader);
	}
	...
	protected void initialize(FileManager loader) {
		button = loader.getTexture("Exit");
		buttonHover = loader.getTexture("ExitOn");
