...
public class ConditionOneButton extends Button {

	public ConditionOneButton(FileManager loader, Clickable parent) {
		super(parent);
		initialize(loader);
	}
	
	public ConditionOneButton(Area area, FileManager loader, Clickable parent) {
		super(area, parent);
		initialize(loader);
	}
	...
	protected void initialize(FileManager loader) {
		button = loader.getTexture("ConditionRed");
		buttonHover = loader.getTexture("ConditionRedHover");
		shape = Shape.Oval;
