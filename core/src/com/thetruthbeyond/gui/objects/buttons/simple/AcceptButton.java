...
public class AcceptButton extends Button {
	...
	public AcceptButton(FileManager loader, Clickable parent) {
		super(parent);
		initialize(loader);
	}
	
	public AcceptButton(Area area, FileManager loader, Clickable parent) {
		super(area, parent);
		initialize(loader);
	}
	...
	protected void initialize(FileManager loader) {
		button = loader.getTexture("Accept");
		buttonHover = loader.getTexture("AcceptHover");
		shape = Shape.Oval;
