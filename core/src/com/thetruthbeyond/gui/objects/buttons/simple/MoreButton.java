...
public class MoreButton extends Button {
    ...
    public MoreButton(FileManager loader, Clickable parent) {
        super(parent);
        initialize(loader);
    }

    public MoreButton(Area area, FileManager loader, Clickable parent) {
        super(area, parent);
        initialize(loader);
    }
    ...
    protected void initialize(FileManager loader) {
        button = loader.getTexture("More");
        buttonHover = loader.getTexture("MoreHover");
        shape = Shape.Oval;
