...
public class TestsButton extends MenuButton {

	public TestsButton(FileManager loader, Clickable parent) {
		super(parent);
		initialize(loader);
	}
	
	public TestsButton(Area area, FileManager loader, Clickable parent) {
		super(area, parent);
		initialize(loader);
	}
	...
	protected void initialize(FileManager loader) {
		button = loader.getTexture("TestMeButton");
		icon = loader.getTexture("TestMeIcon");
		iconHover = loader.getTexture("TestMeIconHover");
