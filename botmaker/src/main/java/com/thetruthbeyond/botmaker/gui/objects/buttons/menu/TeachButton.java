...
public class TeachButton extends MenuButton {

	public TeachButton(FileManager loader, Clickable parent) {
		super(parent);
		initialize(loader);
	}
	
	public TeachButton(Area area, FileManager loader, Clickable parent) {
		super(area, parent);
		initialize(loader);
	}
	...
	protected void initialize(FileManager loader) {
		button = loader.getTexture("TeachButton");
		icon = loader.getTexture("TeachIcon");
		iconHover = loader.getTexture("TeachIconHover");
