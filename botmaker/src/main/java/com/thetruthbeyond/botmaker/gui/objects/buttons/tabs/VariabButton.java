...
import com.thetruthbeyond.botmaker.gui.tabs.teachtab.VariabTab;
...
public class VariabButton extends TabButton {
	
	public VariabButton(FileManager loader, Clickable parent) {
		super(parent);
		initialize(loader);
	}
	
	public VariabButton(Area area, FileManager loader, Clickable parent) {
		super(area, parent);
		initialize(loader);
	}

	protected void initialize(FileManager loader) {
		button = loader.getTexture("Variables");
		buttonHover = loader.getTexture("VariablesHover");
		shape = Shape.Oval;
