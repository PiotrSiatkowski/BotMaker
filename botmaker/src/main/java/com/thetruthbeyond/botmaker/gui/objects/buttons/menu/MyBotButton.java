...
public class MyBotButton extends MenuButton {

	public MyBotButton(FileManager loader, Clickable parent) {
		super(parent);
		initialize(loader);
	}
	
	public MyBotButton(Area area, FileManager loader, Clickable parent) {
		super(area, parent);
		initialize(loader);
	}
	...
	protected void initialize(FileManager loader) {
		button = loader.getTexture("MyBotsButton");
		icon = loader.getTexture("MyBotsIcon");
		iconHover = loader.getTexture("MyBotsIconHover");
