...
import com.thetruthbeyond.botmaker.gui.tabs.teachtab.RandomTab;
...
public class RandomButton extends TabButton {
	
	public RandomButton(FileManager loader, Clickable parent) {
		super(parent);
		initialize(loader);
	}
	
	public RandomButton(Area area, FileManager loader,  Clickable parent) {
		super(area, parent);
		initialize(loader);
	}

	protected void initialize(FileManager loader) {
		button = loader.getTexture("Random");
		buttonHover = loader.getTexture("RandomHover");
		shape = Shape.Oval;
